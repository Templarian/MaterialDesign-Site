import { Component, Input, ElementRef, Injector, Compiler, NgModule, NgModuleRef, ViewContainerRef, ViewChild } from '@angular/core';
...
export class MarkdownComponent {
  @ViewChild('md', { read: ViewContainerRef }) vc: ViewContainerRef;
  ...
  render() {
    ...
    const tmpModule = NgModule({ declarations: [tmpCmp], imports: [BrowserModule] })(class { });
    var self = this;
    this._compiler.compileModuleAndAllComponentsAsync(tmpModule)
      .then((factories) => {
        const f = factories.componentFactories[0];
        const cmpRef = f.create(this._injector, [], null, this._m);
        cmpRef.instance.version = 'dynamic';
        self.vc.clear();
        self.vc.insert(cmpRef.hostView);
        // Code blocks
        setTimeout(function () {
